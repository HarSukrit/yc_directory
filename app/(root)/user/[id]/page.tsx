...
const Page=async({params}:{params:Promise<{id:string}>})=>{
    ...
    return(
        ...
        <Image src={user?.image || 'https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png'}  alt="userimage"  width={220} height={220} className="profile_image" />
