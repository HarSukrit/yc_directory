  ...
  const [post, { select: editorPosts }] = await Promise.all([
    ...
    return(<>
       ...
       <section className='section_container'>
        ...
        <Image  src={post.author?.image || 'https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png'}  alt="avatar" width={64} height={64} className='rounded-full drop-shadow-lg' />
        <div>
